...
class calc: 
	...
	def sin(self): 
		...
		try: 
			...
			self.sqval=math.sin(self.value) 
			self.e.delete(0,END) 
			self.e.insert(0,self.sqval)
	## ADDED - COS
	def cos(self): 
		...
		try: 
			...
			self.sqval=math.cos(self.value) 
			self.e.delete(0,END) 
			self.e.insert(0,self.sqval)
	...
	def __init__(self,master): 
			...
			Button(master,text="sin",width=6,height=4, 
				fg="white",bg="blue", 
				command=lambda:self.sin()).grid(row=3, column=6)
			Button(master,text="cos",width=6,height=4, 
				fg="white",bg="blue", 
